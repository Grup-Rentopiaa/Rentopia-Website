...
export default function NotFoundPage() {
  ...
  function handleBack() {
    token ? navigate("/home", { replace: true }) : navigate("/", { replace: true })
  }
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-20 text-center" style={{ background: '#fff' }}>
        ...
        <img src="/error-404.png" alt="404" style={{ width: 300, maxWidth: '100%', marginBottom: 48 }} />
        <button onClick={handleBack} className="rp-btn-primary px-8 py-3 text-sm font-black">
          Kembali ke Beranda
        </button>
      </div>
